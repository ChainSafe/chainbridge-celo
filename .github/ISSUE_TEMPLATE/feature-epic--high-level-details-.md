---
name: Feature Epic (high-level details)
about: 'This is a template for Feature Epic: it has high-level details, reasoning
  and not-so-much implementation details'
title: EPIC
labels: Epic
assignees: Polycarpik
