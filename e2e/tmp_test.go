...
//	_, err := simulate(s.client2, big.NewInt(101), common.HexToHash("0xe0c7276f084e260b269b3722930af3a91f068a27121f0bcf6f1fc63f2d09d965"), AliceKp.CommonAddress())
//	s.Nil(err)
//}
...
//s.Nil(err)
//bobBalance, err := erc20Contract2.BalanceOf(s.client.CallOpts, BobKp.CommonAddress())
//s.Nil(err)
//log.Debug().Msg(bobBalance.String())

//rec, err := s.client2.Client.TransactionReceipt(context.TODO(), common.HexToHash("0x23d14271e56ff495a9afdca7b91d2d4b250dbcdb783e1ea78647e600842f1fe0"))
//s.Nil(err)
//log.Debug().Msgf("%v", rec.Logs)

//bridgeContract, err := Bridge.NewBridge(s.bridgeAddr, s.client2.Client)
//s.Nil(err)
//dataHash := CreateProposalDataHash(data, handlerContract, m.MPParams, m.SVParams)
//
//res, err := bridgeContract.GetProposal(s.client2.CallOpts, uint8(srcId), uint64(nonce), dataHash)
//s.Nil(err)
