...
$CMD cli --gasLimit $GAS_LIMIT --gasPrice $GAS_PRICE bridge --bridge $BRIDGE_ADDRESS register-resource --bridge $BRIDGE_ADDRESS  --handler $ERC20_HANDLER --resourceId $RESOURCE_ID --targetContract $ERC20_ADDRESS
