...
GENERIC_HANDLER="0x3f709398808af36ADBA86ACC617FeB7F5B7B193E"
...
$CMD cli --gasLimit $GAS_LIMIT --gasPrice $GAS_PRICE bridge register-generic-resource --bridge $BRIDGE_ADDRESS  --handler $GENERIC_HANDLER --resourceId $RESOURCE_ID --targetContract $ERC20_ADDRESS --hash true --execute "store(bytes32)"
